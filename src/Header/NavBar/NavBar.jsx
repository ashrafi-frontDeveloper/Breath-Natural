    ...
    return (
        <div>
            ...
            <div className='flex items-center text-white gap-x-1.5 lg:gap-x-3.5 text-[18px] lg:text-2xl'>
                <img className='lg:w-12 w-7 lg:h-12 h-7' src="/public/svg/navbar/plant.svg" alt="" />
            ...
            <nav className='container pt-14 mx-auto flex items-center justify-between md:hidden'>
                ...
                <div className=' flex gap-x-14'>
                    ...
                    <a id='menu-dropdown' href="#" className='hover:scale-110 transition duration-300'>
                    ...
                    <div className='hover:flex hover:flex-col sm:hidden'>
                      <Menu></Menu>
                    </div>
                </div>
            </nav>
